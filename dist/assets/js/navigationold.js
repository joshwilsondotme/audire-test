(function() {
  ...
  function addSpaceForFixedHeader() {
    if (lastInitialized !== DeviceTypes.MOBILE) {
      ...
      siteMainContent.firstElementChild.style.paddingTop = siteHeader.clientHeight + 'px';
    } else {
      siteMainContent.style.paddingTop = siteHeader.clientHeight + 'px';
      siteMainContent.firstElementChild.style.paddingTop = '0px';
    }
  }
...
$('.site-menu__item--cart').insertAfter('.site-menu__item--btn');
