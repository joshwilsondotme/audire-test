...
$customText = get_field( 'location_list_text', 'location-options' );
...
$output .= "\t\t\t\t" . '<input id="wpsl-search-input" type="text" value="' . apply_filters( 'wpsl_search_input', '' ) . '" name="wpsl-search-input" placeholder="City, ST or Zip Code" aria-required="true" />' . "\r\n";
$output .= "\t\t\t" . '</div>' . "\r\n";
...
$output .= "\t\t\t" . '<div class="padding-y-lg text-component">'.$customText.'</div>' . "\r\n";
$output .= "\t\t\t" . '<ul class=""></ul>' . "\r\n";
$output .= "\t\t" . '</div>' . "\r\n";
$output .= "\t" . '</div>' . "\r\n";
