      ...
      <?php 
        ...
        switch( $provider_icon ) {
          ...
          case 'tiktok':
            ...
            break;
          case 'bbb':
            $provider_icon = '<img src="'. get_template_directory_uri().'/images/svgs/bbb_color.svg" alt="Better Business Bureau logo icon">';
            break;
          case 'healthy-hearing':
            $provider_icon = '<img src="'. get_template_directory_uri().'/images/svgs/healthy-hearing_color.svg" alt="Healthy Hearing logo icon">';
            break;
          default:
        }
