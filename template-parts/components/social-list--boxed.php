<?php if ( have_rows( 'social_media_profiles', 'themes-options' ) ) : ?>
    <?php while ( have_rows( 'social_media_profiles', 'themes-options' ) ) : the_row(); ?>
      ...
      <li class="social-list__item">
        <a class="social-list__link social-list__link social-list__link--<?= $provider_name; ?> bg-<?= $provider_name; ?>" href="<?php echo esc_url( $provider_url ); ?>" target="_blank"><?= $provider_icon; ?></a>
      </li>
